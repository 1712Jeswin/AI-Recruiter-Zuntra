          ...
          {interviewList?.length === 0 ? (
            ...
            <>
              {filteredInterviews.length === 0 ? (
                ...
                <>
                  {/* 👇 Added text for click info */}
                    <div className="mb-8 flex items-start gap-3 p-4 bg-blue-50/50 border border-blue-100 rounded-xl text-blue-800 text-sm">
                       <Pin size={18} className="mt-0.5 text-blue-500 shrink-0 fill-blue-500/20" />
                      <div>
                        <span className="font-semibold block mb-1 text-blue-900">Quick Tip</span>
                            Click any card below to view full interview results, candidate history, and detailed scorecards.
                      </div>
                    </div>
